    ...
    return (
        <div className="relative group/carousel">
            ...
            <div
                ...
                className="flex overflow-x-auto gap-4 sm:gap-6 pb-6 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] px-4 md:px-0 scroll-smooth"
            >
